...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-sNZP8SzM.mjs';
import { u as useContentPreview } from './preview-6qDP3qXy.mjs';
import { l as useState, d as useRuntimeConfig } from './server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CAF1l9qH.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-Bz_x-RYk.mjs.map
