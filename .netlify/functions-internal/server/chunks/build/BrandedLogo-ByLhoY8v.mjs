...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="flex items-start justify-start h-full"><div class="flex flex-col justify-between w-full h-full p-20"><img${ssrRenderAttr("src", __props.logo)} height="50"><h1 class="text-[60px] text-white font-bold text-left">${ssrInterpolate(__props.title)}</h1></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=BrandedLogo-ByLhoY8v.mjs.map
