import { computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, toRef, nextTick, unref, getCurrentScope, onScopeDispose } from 'vue';
import { debounce } from 'perfect-debounce';
import { b as useNuxtApp, h as asyncDataDefaults, c as createError } from './server.mjs';
...
function useNuxtData(key) {
  ...
  return {
    data: computed({
      get() {
        var _a, _b;
        return (_b = (_a = nuxtApp._asyncData[key]) == null ? void 0 : _a.data.value) != null ? _b : nuxtApp.payload.data[key];
      },
      set(value) {
        if (nuxtApp._asyncData[key]) {
...
export { useNuxtData as a, useAsyncData as u };
//# sourceMappingURL=asyncData-CgjrJLH1.mjs.map
