import { a8 as withBase, a7 as withLeadingSlash, n as joinURL, a4 as withoutTrailingSlash, ai as hash } from '../nitro/nitro.mjs';
import { d as useRuntimeConfig, j as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CAF1l9qH.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-sNZP8SzM.mjs.map
