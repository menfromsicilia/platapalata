    ...
    <div class="product-layout">
      ...
      <div class="hero-block">
        ...
        <div class="hero-content">
          <h1 class="product-title">Telegram Stars</h1>
          ...
          <p class="product-description">
            Покупайте звёзды Telegram для доступа к премиум-контенту, поддержки авторов и использования эксклюзивных функций мессенджера.
          </p>
        </div>
      </div>
      ...
      <div class="faq-section">
        ...
        <details>
          <summary>Как быстро приходят звёзды?</summary>
          <div class="faq-answer">
            Звёзды Telegram зачисляются моментально после успешной оплаты. В редких случаях может потребоваться до 15 минут для обработки заказа.
          </div>
        </details>

        <details>
          <summary>Безопасно ли покупать через ваш сервис?</summary>
          <div class="faq-answer">
        ...
        <details>
          ...
          <div class="faq-answer">
            После успешного зачисления звёзд возврат средств невозможен согласно правилам продажи цифровых товаров. Если возникла ошибка при оформлении заказа - свяжитесь с нашей поддержкой, и мы поможем решить проблему.
          </div>
        </details>
        ...
        <details>
          <summary>Для чего нужны Telegram Stars?</summary>
          <div class="faq-answer">
            Telegram Stars используются для доступа к платному контенту в каналах и ботах, для покупки цифровых товаров, поддержки создателей контента и получения эксклюзивных функций в мессенджере.
          </div>
        </details>
      </div>
